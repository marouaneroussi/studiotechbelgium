      ...
      <section className="mission-section">
        <div className="mission-grid">
          <div className="mission-card">
            <h2>Our Mission</h2>
            <p>
              To empower broadcasters with cutting-edge technology solutions
              that enable them to create, manage and distribute exceptional
              content worldwide.
            </p>
          </div>
          <div className="mission-card">
            <h2>Our Vision</h2>
            <p>
              To be the leading innovator in broadcast technology, setting new
              standards for quality, reliability, and creative possibilities in
              the industry.
            </p>
          </div>
          <div className="mission-card">
            <h2>Our Promise</h2>
            <p>
              We commit to delivering excellence in every project, providing
              unparalleled support, and fostering long-term partnerships with
              our clients.
            </p>
          </div>
        </div>
      </section>
      <section className="history-roadmap">
        <h2 className="text-center px-20">Our Journey</h2>
        <div className="milestone-track">
          ...
          <div className="milestone-item">
            <div className="milestone-content">
              <h3>2005</h3>
              <p>
                Expanded operations across Europe, establishing key partnerships
              </p>
            </div>
          </div>
          <div className="milestone-item">
            <div className="milestone-content">
              <h3>2010</h3>
              <p>Launched innovative digital broadcasting solutions</p>
            </div>
          </div>
          <div className="milestone-item">
            <div className="milestone-content">
              <h3>2015</h3>
              <p>
                Achieved milestone of 250+ successful project implementations
              </p>
            </div>
          </div>
          <div className="milestone-item">
            <div className="milestone-content">
              <h3>2020</h3>
              <p>
                Pioneered remote production solutions during global challenges
              </p>
            </div>
          </div>
          <div className="milestone-item">
            <div className="milestone-content">
              <h3>Today</h3>
              <p>
                Leading the industry with innovative broadcast solutions and
                global reach
              </p>
            </div>
          </div>
